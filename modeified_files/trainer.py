...
class TrainerBase:
    ...
    def parse_batch_open(self, batch):
        raise NotImplementedError
...
class SimpleTrainer(TrainerBase):
    ...
    def build_data_loader(self):
        ...
        self.easy_loader = dm.easy_loader
        self.hard_loader = dm.hard_loader
        self.lt_loader = dm.lt_loader
        self.others_loader = dm.others_loader
        self.iNaturalist_loader = dm.iNaturalist_loader
        self.Places_loader = dm.Places_loader
        self.SUN_loader = dm.SUN_loader
        self.Texture_loader = dm.Texture_loader
